...
const Drawer = () => {
  const pathName= usePathname().split("/")[1];
    ...
    return (
      <div className="fixed z-10 flex flex-row justify-around bottom-0 w-full pb-1 sm:block sm:relative sm:float-left sm:flex-col sm:h-screen sm:justify-normal sm:w-auto sm:bg-[#F9FAFC] sm:px-3">
        <div className="flex flex-col items-center">
        <Home className={`mt-7`} stroke={pathName=="Home"?"#212153":"#8A8A8A"}/>
        ...
        <div className="flex flex-col items-center">
        <svg className="lucide lucide-circle-plus  mt-7" xmlns="http://www.w3.org/2000/svg" stroke={pathName==""?"#212153":"#8A8A8A"} width="24" height="24" viewBox="0 0 24 24" fill="none"  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" ><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="M12 8v8"/></svg>
