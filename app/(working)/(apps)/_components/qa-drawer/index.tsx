  ...
  return (
      <Form {...form}>
        ...
        <form
          ...
          className="flex flex-col h-[80vh] items-center justify-between w-full"
        >
          <div className="h-[380px] flex flex-col justify-around w-full">
            <div className="w-[90vw] mx-auto lg:w-[400px]">
            <FormField
              ...
              return (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange}>
                    <FormControl>
                    <SelectTrigger className="w-full bg-[#F2F5FF]">
                ...
                <PopoverTrigger asChild>
                  <FormControl>
                    <Button
                      variant={"outline"}
                      className={cn(
                        "w-[41vw] lg:w-[180px] bg-[#F2F5FF] border-none pl-3 text-left font-normal",
        ...
        />
          ...
          <FormField
            ...
            render={({ field }) => {
              return (
                <FormItem>
                  <FormLabel>ENTER qwe</FormLabel>
                  <FormControl>
                    <Input
                    className="w-[40vw] lg:w-[180px] bg-[#F2F5FF] border-none focus-visible:ring-0 focus-visible:ring-transparent  focus-visible:ring-offset-0   text-black"
                    placeholder="number"
                    type="number" {...field}
                    />
                  </FormControl>
            ...
            render={({ field }) => {
              return (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      className="w-[40vw] lg:w-[180px] bg-[#F2F5FF] m-0 border-none focus-visible:ring-0 focus-visible:ring-transparent  focus-visible:ring-offset-0   text-black"
                      placeholder="number"
                      type="number" {...field}
                    />
                  </FormControl>
